...
const ChatPage = () => {
    ...
    const { messages: contextMessages, loading, streaming, setActiveThread, activeThreadId, resetChat } = useChat();
        ...
        setTimeout(() => {
            ...
            if (mock) {
                ...
                setMessages(prev => [...prev, { 
                    id: (Date.now() + 1).toString(), 
                    role: 'assistant', 
                    content: "I've analyzed your request. Based on current market benchmarks, I suggest refining your audience parameters. Would you like to proceed with a draft campaign plan?",
                    created_at: new Date().toISOString()
                }]);
            }
            setIsLoading(false);
