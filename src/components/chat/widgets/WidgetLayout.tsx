...
const WidgetLayout: React.FC<WidgetLayoutProps> = ({
  ...
  if (mode === 'split') {
    return (
      <div className="flex flex-col justify-between lg:flex-row gap-6 h-full px-2 min-h-0 w-full">
  ...
  return (
    <div
      className={`w-full max-w-4xl flex flex-col gap-4 animate-fade-up ${className}`}
    >
