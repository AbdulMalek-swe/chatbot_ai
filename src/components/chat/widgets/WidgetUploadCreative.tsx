                ...
                <div className="p-4 bg-slate-50 border border-slate-200 rounded-2xl shadow-sm flex flex-col gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-sm font-bold text-slate-900 font-inter">Upload Complete</span>
                            <span className="text-[11px] text-slate-500 font-medium">{files.length} files processed successfully</span>
                        </div>
                    </div>
                    
                    <div className="grid grid-cols-4 gap-2">
                        {files.slice(0, 4).map((file, i) => (
                            <div key={i} className="aspect-square rounded-lg bg-white border border-slate-200 flex items-center justify-center overflow-hidden">
