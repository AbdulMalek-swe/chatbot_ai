...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`${isCollapsed ? 'w-20' : 'w-72'} flex flex-col h-full transition-all duration-300 relative`}
    >
      <div className="px-3">
      ...
      <nav className="px-3 mt-4 flex flex-col gap-1">
        ...
        >
          ...
          {!isCollapsed && (
            <Link
              to="/campaigns"
              className="text-sm font-medium text-slate-500 group-hover:text-slate-900"
            >
              Campaigns
            </Link>
          )}
      ...
      <div className="flex-1 flex flex-col mt-10 min-h-0 overflow-hidden">
        {!isCollapsed && (
          <div className="px-6 mb-2">
            <h3 className="text-xs  text-#151515 tracking-tight">
              Chat History
            </h3>
