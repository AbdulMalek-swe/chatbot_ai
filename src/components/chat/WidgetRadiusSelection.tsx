...
export default function WidgetRadiusSelection({ 
    ...
    return (
        <div className="w-full flex flex-col lg:flex-row gap-6 animate-fade-up">
            {/* Left Card: Chat-like interface */}
            <div className="w-full lg:w-[450px] bg-white rounded-[24px] shadow-sm border border-slate-100 flex flex-col overflow-hidden">
                <div className="p-6">
                    {/* Header */}
            ...
            {/* Right Side: Map */}
            <div className="flex-1 min-h-[500px] lg:h-auto rounded-[24px] overflow-hidden border border-slate-200 relative shadow-sm">
                <MapContainer
                    center={center}
                    zoom={14}
